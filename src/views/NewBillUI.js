    ...
    <div class='layout'>
      ...
      <div class='content'>
        <div class='content-header'>
          <div class='content-title' data-testid="new-bill-title"> Envoyer une note de frais </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <span class='error-message hidden-message' data-testid="file-error-message">Format de fichier non autorisé, merci d'uploader une image au format jpg, jpeg ou png</span>
                  </div>
                </div>
            </div>
            <div class="row">
